<#
    ...
    .EXAMPLE
    OCC-Connector
    call-wizard-only.ps1 -customerID "CustomerID" -apikey "APIKey" -OCCConnector
...
[System.IO.FileInfo]$SEPath = $Servicepath.PathName -replace '"', '' | Split-Path
[System.IO.FileInfo]$WizardPath = Join-Path -Path $SEPath -ChildPath "\Wizard.exe"
...
$argument = "{0} --customerID={1} --apiKey={2} --silent=true --cleanup={3}{4}{5}" -f $Install, $customerID, $apikey, $cleanup.toString().ToLower(), $template, $Proxy 
$startProcessParams = @{
    FilePath     = $WizardPath
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUpXSP5O8ZCqOUzb8NndJa3WRu
# gQKggh8aMIIFQDCCBCigAwIBAgIQPoouYh6JSKCXNBstwZR1fDANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMavHAZGUMS8W6NQTb6/qv6C
# xsPhMA0GCSqGSIb3DQEBAQUABIIBAIcVQLdKwRri7C6pYdePqHQNnswD5Nevr0bs
# sUR8kM/npMYX0xhqdwsrWW86ravIkYBmgLTjhU/zkEgOIaSfBXOh9nWq4MdVPV/2
# pq7rSSA9gbJ3he/aqKj1xhNNpwo0v0JnzbbPSO2FPxEipFFbHUHi41Jz6CH0dq4B
# xgZan9Q3LVl/XeFYRFUVU66egmwRSNl0hK9sA/lW++NzrJp1K7xfaUm4o2RRN5mW
# dXvw5sOJlpfHKJaAAIVPXkrGSwgQwukuDGpz1f2V17WJDQZUSMwBs7cwz1T19qYp
# hdElQKTqr5Q81R2A6IgQdKtgpQBmBamZPUT5KwP+CRIpQ8+WJ1mhggNMMIIDSAYJ
...
# SIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIxMTExMTA3NDc1
# M1owPwYJKoZIhvcNAQkEMTIEMBCdagT9QPBX8fBUmDAoK7UHGQVnd7VDQD/7TZ7a
# 2n12eUatebFioeiz8sonc1rTVjANBgkqhkiG9w0BAQEFAASCAgBWsZfYFdUnfW7W
# HQqkRuA0/OTP6pV+R8koXkEZfd/KmVzsKrJIGCVXlUNk0EDn2mxWGitLtilT7f79
# MJaGSnMcRbY1ryX3rX3rHvCLqvdr1skfmsH65BmnfsJENfvcfAoUPf6jNVfMQ+fu
# iqq4AW+XiXpZKx64uM+zBwne8+WFz3GADvfKCkqntxfiYEj/mZfRwMFIFaYLC67Z
# kxd652mWQJHujGbBFasmsT2gOoqnPmsgpW+x1DNlqreUpPZNIaMBBOQY12URy7op
# hn49obkNM9i1DLQs1oGhny1CLDLAPyyY9gRlSPMWujEhs9ytTNmXz5jNmkRt8M57
# sb6SJNGoxy7+K2rcNPYknbbwHYKP3rIqJnHEo10gX7UPGy2p1WfPSY028SU8j5Kn
# hPLpFV9kTH521DsZo1w3dy/Ek/LnduofBnL7+2X8wjoyDAQbnJycJZbV2jXajsq0
# cqyFP87FUul6mp2MUcG++c85CfxaxtfGUnYvNs9nVTfFL+aCHaQebQ/Ky05d+SYy
# hfFANn1YOHRogHYI6FNLy32iscIriu6jkJCaxPx9rp6/DtcpcBKmD74fZpMh4tqp
# 3NSfkG5pIe0616H4YV7nGHhtF137fu85j+GUZR3N+w6bQWAAU8wNPjvxua3aZ4KX
# /RWAacBQ5NSB3kVzEP+ybm3GPfu2uA==
