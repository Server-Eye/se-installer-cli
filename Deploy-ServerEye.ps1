...
function Test-SEInvalidParameterization {
	...
	try {
		$null = Invoke-WebRequest -Method Post -Uri "https://api.server-eye.de/3/auth/login" -Headers @{ "x-api-key" = "270e7293-8fba-4588-84e9-b4bf2dbae41a" } -UseBasicParsing -ErrorAction Stop
	} catch {
